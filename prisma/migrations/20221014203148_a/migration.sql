/*
  ...
  - You are about to drop the column `ookstore_Id` on the `book` table. All the data in the column will be lost.
...
CREATE TABLE "new_book" (
    ...
    CONSTRAINT "book_bookstore_Id_fkey" FOREIGN KEY ("bookstore_Id") REFERENCES "bookstore" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
